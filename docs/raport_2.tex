...
Decyzja o zmianie zakresu badań w części dotyczącej języka nepalskiego na ograniczony zbiór hiszpański wynikała z problemów metodologicznych przy ewaluacji generacji tekstu w języku o odmiennym alfabecie. Przejście na \textit{downsampled Spanish} pozwoliło na rzetelne porównanie numeryczne (z zachowaniem tej samej metryki ROUGE) i wyciągnięcie wniosków dotyczących efektywności metod przy małej liczbie danych.
